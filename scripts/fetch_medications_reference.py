...
SEED_DRUGS = [
    "Paracetamol", "Ibuprofen", "Aspirin", "Diclofenac", "Naproxen", "Tramadol",
    "Amoxicillin", "Azithromycin", "Ciprofloxacin", "Doxycycline", "Metronidazole",
    "Ceftriaxone", "Cephalexin", "Clindamycin", "Trimethoprim",
    "Metformin", "Glibenclamide", "Gliclazide", "Insulin", "Sitagliptin",
    "Atorvastatin", "Simvastatin", "Rosuvastatin",
    "Amlodipine", "Losartan", "Telmisartan", "Enalapril", "Ramipril", "Bisoprolol",
    "Atenolol", "Hydrochlorothiazide", "Furosemide", "Spironolactone",
    "Warfarin", "Clopidogrel", "Heparin", "Rivaroxaban",
    "Omeprazole", "Pantoprazole", "Esomeprazole", "Ranitidine", "Ondansetron",
    "Salbutamol", "Montelukast", "Budesonide", "Fluticasone", "Theophylline",
    "Cetirizine", "Loratadine", "Levothyroxine", "Prednisolone", "Dexamethasone",
    "Hydrocortisone", "Sertraline", "Fluoxetine", "Amitriptyline", "Diazepam",
    "Lorazepam", "Levetiracetam", "Gabapentin", "Morphine", "Metoclopramide",
]
